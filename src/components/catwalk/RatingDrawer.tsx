      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 overflow-y-auto">
          ...
          <motion.div
            ...
            className="relative w-full max-w-2xl z-10 bg-slate-900/95 border border-white/15 rounded-3xl shadow-2xl backdrop-blur-2xl text-slate-100 p-5 sm:p-7 max-h-[90vh] overflow-y-auto custom-scrollbar select-none my-auto"
          >
